...
if VERSION < v"1.3.0-rc4"
    ...
    error("Unable to import Sundials32_jll on Julia versions older than 1.3!")
end
...
artifacts = Pkg.Artifacts.load_artifacts_toml(artifacts_toml; pkg_uuid=UUID("3d421925-9ddb-5fba-844f-eab55ed40f51"))
platforms = [Pkg.Artifacts.unpack_platform(e, "Sundials32", artifacts_toml) for e in artifacts["Sundials32"]]
...
if best_platform === nothing
    @debug("Unable to load Sundials32; unsupported platform $(triplet(platform_key_abi()))")
else
